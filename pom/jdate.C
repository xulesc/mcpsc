...
const Weekdays JDate::weekdays[] = { "Sun", "Sunday", "Mon", "Monday", "Tue",
		"Tuesday", "Wed", "Wednesday", "Thu", "Thursday", "Fri", "Friday",
		"Sat", "Saturday" };

const Months JDate::months[] = { "Jan", "January", "Feb", "February", "Mar",
		"March", "Apr", "April", "May", "May", "Jun", "June", "Jul", "July",
		"Aug", "August", "Sep", "September", "Oct", "October", "Nov",
...
int JDate::jday(int month, int day, int year) {
	...
	int jd = abs((146097 * century) / 4) + abs((1461 * anni) / 4)
			+ abs((153 * month + 2) / 5) + day + 1721119;
