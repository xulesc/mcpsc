...
void alignToSeq(int *align1, int1 *seq1, int nse1, int1 *seq2, int nse2,
		int1 **seq1a, int1 **seq2a, int& nSeqa, int& seqMatchFrom,
		int& seqMatchTo, int endsMode = 0);
...
public:
	...
	void distr(int ix, int iy, char *title, int xmin, int xmax, int ymin,
			int ymax, int *array, int nx, int ny, int width, int xmarks,
